<div id="reportprofilesuccessmodal" class="js-modal-window u-modal-window" style="width: 620px;">
    <div class="card mb-9">
        <!-- Header -->
                            ...
                            <div class="position-relative">
                                <div id="SVGcircleProcess3" class="svg-preloader min-height-155 mb-2">
                                    ...
                                    <figure class="w-100 position-absolute top-0 right-0 left-0 z-index-n1">
                                        <img class="js-svg-injector" src="<?= $this->Url->build('/svg/', ['fullBase' => true]); ?>circle-process-3.svg" alt="Image Description" data-parent="#SVGcircleProcess3">
                                    </figure>
                                    <!-- End SVG Shape -->
                                </div>
