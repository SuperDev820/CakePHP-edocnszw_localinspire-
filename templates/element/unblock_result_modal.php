    ...
    <div class="card mb-9">
        ...
        <header class="card-header bg-light py-3 px-5">
            <div class="d-flex justify-content-between align-items-center">
                <h3 class="h6 bold mb-0"><span class="unblockeduser"></span>  unblocked successfully</h3>
                            ...
                            <div class="position-relative">
                                <div id="SVGcircleProcess11" class="svg-preloader min-height-155 mb-2">
                                    ...
                                    <figure class="w-100 position-absolute top-0 right-0 left-0 z-index-n1">
                                        <img class="js-svg-injector" src="<?= $this->Url->build('/svg/', ['fullBase' => true]); ?>circle-process-3.svg" alt="Image Description" data-parent="#SVGcircleProcess11">
                                    </figure>
                                    <!-- End SVG Shape -->
                                </div>

                                <h2 class="h4 font-weight-semi-bold text-primary">&nbsp;</h2>
                                <p class="mb-10"><span class="unblockeduser"></span> has been successfully unblocked.</p>
                            </div>
                            <!-- End Process -->
                        </div>
