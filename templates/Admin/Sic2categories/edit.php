<?php $this->assign('title', 'Edit Sic2Category'); ?>
<section id="horizontal-form-layouts">
    <div class="row">
        <div class="col-sm-12">
            <div class="content-header">Edit Sic2Category</div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="px-3">
                        <?php echo $this->Form->create($sic2category, ['class' => 'form form-horizontal', 'enctype' => 'multipart/form-data']) ?>
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 label-control" for="sic4categories._ids">Child Sic4Categories
                                    <span class="required" aria-required="true"> * </span>
                                </label>
                                <div class="col-md-6">
