<?php $this->assign('title', 'Reported Reviews'); ?>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-8">
                            <h4 class="card-title">Reported Reviews</h4>
                        </div>
                ...
                <div class="card-body collapse show">
                    <div class="card-block card-dashboard">
                        ...
                        <?php echo $this->element('report_reviews_table', ['userid' => null, 'showUser' => true, 'ajax' => true, 'show_edit' => false, 'show_remove' => false, "idtouse" => "report_reviews_table", "record_name" => "Reported reviews", "searching" => true]) ?>
                    </div>
                </div>
            </div>
        </div>
