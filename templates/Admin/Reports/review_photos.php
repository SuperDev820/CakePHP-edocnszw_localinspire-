<?php $this->assign('title', 'Reported Review Photos'); ?>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-8">
                            <h4 class="card-title">Reported Review Photos</h4>
                        </div>
                ...
                <div class="card-body collapse show">
                    <div class="card-block card-dashboard">
                        ...
                        <?php echo $this->element('report_review_photos_table', ['userid' => null, 'showUser' => true, 'ajax' => true, 'show_edit' => false, 'show_remove' => false, "idtouse" => "report_review_photos_table", "record_name" => "Photos", "searching" => true]) ?>
                    </div>
                </div>
            </div>
        </div>
