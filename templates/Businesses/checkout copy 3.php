<?php $this->assign('title', "Checkout Subscription for " . $business->name . " - " . $business->city->name . ", " . $business->city->state->code); ?>
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body p-5">
                        ...
                        <!-- <div class="media-body text-left">
                            ...
                            <?= $business->city->name; ?>, <?= $business->city->state->code; ?> - <?= $business->zip ?></span><br>
                ...
                <div class="card-body">
                    ...
                    <div id="creditCard" data-target-group="paymentMethods">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <?= $this->Form->button(__('Pay and Susbcribe'), ['type' => 'submit', 'value' => "Pay", 'class' => 'btn btn-primary transition-3d-hover', 'style' => '', 'id' => 'payBtn']); ?>
                        </div>
                        <!-- End Button -->
                    </div>
                    <!-- End Credit Card -->
...
<script>
    ...
    // Stripe.setPublishableKey('<?= $api_pub_key ?>');
