    ...
    <ul class="navbar-nav u-header__navbar-nav">
        ...
        <?php if (!$home) : ?>
            <li class="nav-item sr-has-mega-menu u-header__nav-item">
                <a class="nav-link mr-2 text-dark" href="<?= $this->Url->build(['prefix' => false, 'controller' => 'search', 'action' => 'index', '?' => ['find' => 'Hotels', 'location' => isset($currentLocation['city']) ? $currentLocation['city'] . "-" . $currentLocation['region'] : '']]); ?>">Hotels</a>
            </li>
            <li class="nav-item sr-has-mega-menu u-header__nav-item">
                <a class="nav-link mr-2 text-dark" href="<?= $this->Url->build(['prefix' => false, 'controller' => 'search', 'action' => 'index', '?' => ['find' => 'Restaurants', 'location' => isset($currentLocation['city']) ? $currentLocation['city'] . "-" . $currentLocation['region'] : '']]); ?>">Restaurants</a>
            </li>
            <li class="nav-item sr-has-mega-menu u-header__nav-item">
                <a class="nav-link mr-2 text-dark" href="<?= $this->Url->build(['prefix' => false, 'controller' => 'search', 'action' => 'index', '?' => ['find' => 'Cabins', 'location' => isset($currentLocation['city']) ? $currentLocation['city'] . "-" . $currentLocation['region'] : '']]); ?>">Cabins</a>
            </li>
            <li class="nav-item sr-has-mega-menu u-header__nav-item">
                <a class="nav-link mr-2 text-dark" href="<?= $this->Url->build(['prefix' => false, 'controller' => 'search', 'action' => 'index', '?' => ['find' => 'Vacation Rentals', 'location' => isset($currentLocation['city']) ? $currentLocation['city'] . "-" . $currentLocation['region'] : '']]); ?>">Vacation Rentals</a>
            </li>
            <li class="nav-item sr-has-mega-menu u-header__nav-item">
                <a class="nav-link mr-2 text-dark" href="<?= $this->Url->build(['prefix' => false, 'controller' => 'search', 'action' => 'index', '?' => ['find' => 'Things to do', 'location' => isset($currentLocation['city']) ? $currentLocation['city'] . "-" . $currentLocation['region'] : '']]); ?>">Things to do</a>
            </li>

            <li class="nav-item sr-has-mega-menu u-header__nav-item pr-3 ">
                <a class="nav-link text-dark" href="<?= $this->Url->build(['prefix' => false, 'controller' => 'search', 'action' => 'index', '?' => ['find' => 'Cruises', 'location' => isset($currentLocation['city']) ? $currentLocation['city'] . "-" . $currentLocation['region'] : '']]); ?>">Cruises</a>
            </li>
            <li class="nav-item sr-has-mega-menu u-header__nav-item pr-3 ">
                <a class="nav-link text-dark" href="<?= $this->Url->build(['prefix' => false, 'controller' => 'stories', 'action' => 'index']); ?>">Stories</a>
            </li>
        <?php endif; ?>
        ...
        <li class="nav-item sr-has-mega-menu u-header__nav-item before_login">
            <a class="btn btn-sm btn-link loginn" href="#loginModal" data-modal-target="#loginModal" data-target="#login"> <i class="fas text-dark fa-user-circle font-size-3"></i></a>
        </li>
        ...
        <li class="after_login position-relative  mt-1 sr-has-mega-menu " data-event="hover" data-animation-in="slideInUp" data-animation-out="fadeOut" data-max-width="260px" data-position="right">
            <a id="messagesMegaMenu" class=" nav-link  " href="javascript:;" aria-haspopup="true" aria-expanded="false">
                ...
                <i class="far text-dark  mr-2 font-size-15 fa-comment-alt"></i>
            </a>
            <!-- Messages - Submenu -->
            <div class="after_login borderlt sr-mega-menu u-header__sub-menu" aria-labelledby="messagesMegaMenu" style="min-width: 330px;" id="notifications_unread_messages">
        ...
        <li class="after_login position-relative  mt-1 sr-has-mega-menu " data-event="hover" data-animation-in="slideInUp" data-animation-out="fadeOut" data-max-width="260px" data-position="right">
            <a id="docsMegaMenu" class="after_login nav-link" href="javascript:;" aria-haspopup="true" aria-expanded="false">
                ...
                <i class="fas font-size-15  mr-2 text-dark fa-bell"></i>
            </a>
            <!-- Notifications - Submenu -->
            <div class="after_login borderlt  sr-mega-menu u-header__sub-menu" aria-labelledby="docsMegaMenu" style="min-width: 330px;" id="notifications_unread">
        ...
        <li class="after_login position-relative  mt-1 sr-has-mega-menu " data-event="hover" data-animation-in="slideInUp" data-animation-out="fadeOut" data-max-width="260px" data-position="right">
            ...
            <!-- Account - Submenu -->
            <div class="after_login borderlt sr-mega-menu u-header__sub-menu" aria-labelledby="notificationMegaMenu" style="min-width: 250px;">
                <!-- Promo Item -->
                <div class="p-0">
                    <!-- Content -->
                    <div class="after_login u-sidebar__body">
                        ...
                        <!--<header class="after_login d-flex align-items-center u-sidebar--account__holder mt-0">
                            ...
                            <div class="btn-group position-relative ml-auto mb-auto">
                                <a id="sidebar-account-settings-invoker" class="btn btn-xs btn-icon btn-text-secondary rounded" href="<?= $this->Url->build(['prefix' => false, 'controller' => 'account', 'action' => 'index']); ?>">
                        ...
                        <div class="after_login pt-3">
                            <!-- List Links -->
                            <ul class="after_login list-unstyled u-sidebar--account__list ml-3 mr-3">
                                
                              
                                    
                                    
                                      <li class="u-sidebar--account__list-item">
                                    <a class="u-sidebar--account__list-link" href="<?= $this->Url->build(['prefix' => false, 'controller' => 'account', 'action' => 'profile']); ?>">
                                        <figure class="ie-height-56 max-width-4">
                                            <img class="js-svg-injector float-left" src="<?= $this->Url->build('/svg/icon-18.svg', ['fullBase' => true]); ?>" alt="SVG" data-parent="#icon35">
                                        </figure>
                                        <div class="ml-6 pt-1 pb-0">View
                                    profile</div>
                                    </a>
                                </li>
                                ...
                                <li class="u-sidebar--account__list-item">
                                    <a class="u-sidebar--account__list-link" href="<?= $this->Url->build(['prefix' => false, 'controller' => 'account', 'action' => 'index']); ?>">
                                        ...
                                        <div class="ml-6 pt-1 pb-0">Account</div>
                                    </a>
                                </li>
                                <li class="u-sidebar--account__list-item">
                                ...
                                <?php if (!empty($currentUser) and ($currentUser->sa or $currentUser->admin)) {  ?>
                                    <li class="u-sidebar--account__list-item">
                                        <a class="u-sidebar--account__list-link" href="<?= $this->Url->build(["prefix" => 'Admin', 'controller' => 'dashboard', 'action' => 'index']); ?>">
                                            <figure class="ie-height-56 max-width-4">
                                                <img class="js-svg-injector float-left" src="<?= $this->Url->build('/', ['fullBase' => true]); ?>svg/icon-46.svg" alt="SVG" data-parent="#icon56">
                                            </figure>
                                ...
                                <li class="u-sidebar--account__list-item">
                                    <a class="u-sidebar--account__list-link" href="<?= $this->Url->build(['prefix' => false, 'controller' => 'Api', 'action' => 'logout']); ?>">
                                        ...
                                        <div class="ml-6 pt-1 pb-0">Sign out</div>
                                    </a>
                                </li>
                            </ul>
                            <!-- End List Links -->
