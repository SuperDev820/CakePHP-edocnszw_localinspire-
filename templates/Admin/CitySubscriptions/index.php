<?php $this->assign('title', 'City Subscriptions'); ?>
<style>
    /* td {
        text-align: left;
    } */
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-8">
                            <h4 class="card-title">City Subscriptions</h4>
                        </div>
                ...
                <div class="card-body collapse show">
                    <div class="card-block card-dashboard">
                        ...
                        <?= $this->element('city_subscriptions_table', ['ajax' => true, 'show_edit' => false, 'show_remove' => false, 'idtouse' => 'city_subscriptions_table']) ?>
                    </div>
                </div>
            </div>
        </div>
