<?php $this->assign('title', 'Edit City Subscription Info'); ?>
<section id="horizontal-form-layouts">
    <div class="row">
        <div class="col-sm-12">
            <div class="content-header">Edit City Subscription Info for <?= $citySubscriptions->city->name ?></div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="px-3">
                        <?php echo $this->Form->create($citySubscription, ['class' => 'form form-horizontal', 'enctype' => 'multipart/form-data']) ?>
